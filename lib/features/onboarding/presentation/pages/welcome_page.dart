...
class _WelcomePageState extends State<WelcomePage> with SingleTickerProviderStateMixin {
            ...
            child: SlideTransition(
              ...
              child: Column(
                children: [
                  Expanded(
                    flex: 5,
                    child: _buildCVTemplatesShowcase(c),
                  ),
                  Expanded(
                    flex: 4,
                    child: _buildWelcomeContent(c),
                  ),
                  Padding(
    ...
    return Padding(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: 10, top: 60,
            child: _buildFloatingCVCard('John Doe', 'Software Engineer', c.primaryStart, -10),
          ),
          Positioned(
            right: 5, top: 20,
            child: _buildFloatingCVCard('Emily Kim', 'Product Manager', c.accentGreen, 10),
          ),
          Positioned(
            right: 20, bottom: 30,
            child: _buildFloatingCVCard('David White', 'UX Designer', c.accent, 5),
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          Expanded(
            child: GridView.count(
              ...
              children: [
                _buildMiniTemplate(c.primaryStart, 'Modern'),
                _buildMiniTemplate(c.accentGreen, 'Classic'),
                _buildMiniTemplate(c.accent, 'Creative'),
                _buildMiniTemplate(c.accentOrange, 'Professional'),
              ],
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(),
          Center(
            child: Text(name, style: TextStyle(fontSize: 8, fontWeight: FontWeight.w600, color: accentColor)),
          ),
        ],
      ),
    );
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(name, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.black87)),
            Text(title, style: TextStyle(fontSize: 7, color: Colors.grey.shade600)),
            const Spacer(),
  ...
  Widget _buildWelcomeContent(AppColorsDynamic c) {
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            'welcome.subtitle'.tr(),
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: c.textSecondary),
            textAlign: TextAlign.center,
          ),
          ...
          Row(
            ...
            children: [
              _buildStatItem('1M+', 'welcome.users'.tr(), c),
              const SizedBox(width: 40),
              _buildStatItem('4.8', 'welcome.rating'.tr(), c),
            ],
          ),
          const SizedBox(height: 24),
          Text(
  ...
  Widget _buildStatItem(String value, String label, AppColorsDynamic c) {
    return Column(
      children: [
        Row(
          children: [
            Icon(Icons.emoji_events, color: c.accentOrange, size: 20),
        ...
        Text(label, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: c.textMuted), textAlign: TextAlign.center),
      ],
    );
  }

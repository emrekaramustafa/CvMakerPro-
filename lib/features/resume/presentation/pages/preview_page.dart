      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: _pdfPath == null ? null : () async {
              final isPremium = context.read<ResumeProvider>().currentResume?.isPremium ?? false;
              if (!isPremium) {
              ...
              await Share.shareXFiles([XFile(_pdfPath!)], text: 'Here is my resume generated by AI Resume Pro');
            },
          ),
        ],
      ),
